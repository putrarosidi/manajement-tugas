...
class ProdukDetailState extends State<ProdukDetail> {
          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  _buildDetailRow(Icons.tab_sharp, 'Id:', widget.sw.id.toString()),
                  _buildDetailRow(Icons.tab, 'Judul:', widget.sw.judul),
                  _buildDetailRow(Icons.description, 'deskripsi:', widget.sw.deskripsi),
                  _buildDetailRow(Icons.book, 'keterangan:', widget.sw.keterangan),
                ],
              ),
            ),
          ),
  ...
  Widget _buildDetailRow(IconData icon, String label, String value) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, size: 30, color: Colors.lightBlue[600]),
          SizedBox(width: 15),
          Expanded(
            child: Text(
              '$label $value',
